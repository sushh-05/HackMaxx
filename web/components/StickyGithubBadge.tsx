  ...
  return (
    ...
    >
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="group flex items-center gap-1.5 rounded-full border border-border/70 bg-card/85 px-2.5 py-1 text-xs text-muted-foreground shadow-md backdrop-blur-md transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/50 hover:bg-card hover:text-foreground hover:shadow-lg hover:shadow-primary/10"
      ...
      >
        ...
        <span className="font-mono text-[11px] font-medium tracking-tight">sushh-05/HackMaxx</span>
        <IconExternal className="size-3 opacity-50 transition-opacity group-hover:opacity-100" />
      </a>
    </aside>
  );
}
