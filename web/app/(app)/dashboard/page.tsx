    ...
    <section className="space-y-6 pt-4 sm:pt-6">
      ...
      {compareIds.length > 0 && (
        <div className="fixed inset-x-0 bottom-4 z-40 flex justify-center px-4 pointer-events-none">
          <div role="status" aria-live="polite" className="pointer-events-auto flex items-center gap-2.5 sm:gap-3.5 rounded-2xl border border-action/40 bg-card/95 backdrop-blur-md px-3.5 py-2.5 sm:px-5 sm:py-3 shadow-2xl max-w-[calc(100vw-32px)] sm:max-w-none">
